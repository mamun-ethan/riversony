...
const searchStates = async searchText => {
  ...
  let matches = productStates.filter(state => {
    ...
    return state.title.match(regex) || state.productid.match(regex) || state.desc.match(regex);
  });
...
//ViewContent
function ViewContent (product_id, product_title, product, product_price, product_category) {
